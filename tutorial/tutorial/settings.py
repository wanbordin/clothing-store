...
SECRET_KEY = 'django-insecure-1af!i@+)vb&ubrf%kej_f7+5y$h3@niplbxmd)kr91^p71fh8u'
...
STATICFILES_DIRS = [
    ...
    # '/oaesystem/oaeapp/static/',
    '/tutorial/anime/static/',
]
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), 'staticfile')

MEDIA_URL = '/media/'

# MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), 'oaesystem/oaeapp/mediafile')
